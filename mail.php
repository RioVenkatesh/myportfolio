...
if ($name == "") {
    ...
    $headers .= 'From:  Papr <mvenkateshsmart@gmail.com>' . "\r\n";
    $headers .= 'cc: mvenkateshsmart@gmail.com' . "\r\n";
    $headers .= 'bcc: mvenkateshsmart@gmail.com' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f mvenkateshsmart@gmail.com');
